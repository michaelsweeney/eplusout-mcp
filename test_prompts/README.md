...
| Prompt | Tools tested | Cross-reference? |
|--------|-------------|-----------------|
| `01_cross_reference_meters` | All 6 | SQL annual sums vs HTML End Uses totals |
| `02_unmet_hours_investigation` | All 6 | Unmet hours (HTML) + boiler timeseries (SQL) + zone sizing (HTML) |
